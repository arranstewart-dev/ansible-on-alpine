# Separate builder layer saves a couple hundred MB
...
ARG GIT_COMMIT_DATE
ARG VERSION
ARG REPO="https://github.com/arranstewart/ansible-on-alpine"

LABEL maintainer="arran@arranstewart.io"
LABEL org.label-schema.schema-version="1.0"
LABEL org.label-schema.description="Basic Ansible installation running on alpine"
LABEL org.label-schema.vcs-url="$REPO"
LABEL org.label-schema.vcs-ref=$GIT_REF
LABEL org.label-schema.version=$VERSION

LABEL vcs-ref-date=$GIT_COMMIT_DATE
